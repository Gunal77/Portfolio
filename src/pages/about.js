    ...
    <div className=" mx-auto max-w-6xl p-5 py-8 md:py-20" id="about">
      ...
      <div className="items-center space-y-8 md:flex md:space-y-0">
        ...
        <div className="basis-2/3 space-y-4">
          ...
          <div className="text-4xl font-bold text-cyan-500">Thirumalai S</div>
          <div className="text-xl font-semibold text-gray-500">MERN Stack Developer</div>
...
const social = [
  {
    ...
    link: 'https://www.linkedin.com/in/thirumalai-s-998335244',
  },
  {
    icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg',
    link: 'https://github.com/Gunal77',
  },
  {
    icon: 'https://cdn-icons-png.flaticon.com/512/1384/1384063.png',
    link: 'https://instagram.com/____gunal____?utm_source=qr&igshid=OGU0MmVlOWVjOQ%3D%3D',
  },
  {
    icon: 'https://cdn-icons-png.flaticon.com/512/732/732200.png',
    link: 'mailto: thirumalaigunal7@gmail.com',
  },
];
